...
legend.onAdd = function () {
    ...
    <div style="width: 250px; margin-left: 0.9rem; margin-top: 0.5rem;">
        <img src="/static/img/tvk2.png" alt="hong có" style="width: 100%; height: auto; border-radius: 8px; margin-left: 0.14rem; margin-top: 0.5rem"/>
       
        <h3 style="margin: 10px 0 5px;; text-align: center; color: RGB(45, 132, 203)">GS25 Trần Văn Kiểu</h3>
        ...
        <br/>  
        <p style="margin: 0;"><i class="fa-solid fa-phone"></i> Số điện thoại: 0987654321</p>
        <br/>  
        <p style="margin: 0;"><i class="fa-solid fa-location-dot"></i> Địa chỉ: 45-47 Đ. Trần Văn Kiểu, Khu II, Quận 6, Hồ Chí Minh, Việt Nam</p>
      </div>
  `;
    return div;
};
